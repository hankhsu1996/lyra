...
// resume it. Every layer below consumes that fact, and a lowering that breaks
// it is refused here, where the body is still named after what the source
// wrote, rather than as a machine-level fault one lowering later or as another
// compiler's error against generated text.
