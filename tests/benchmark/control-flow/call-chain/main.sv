...
// @work: iteration
//
// A fixed, non-recursive chain of sixteen function calls, each doing work that
// cannot be constant-folded. The accumulator feeds back into the next call, so
// what an iteration costs is what the chain costs to enter and leave.
module Top;
