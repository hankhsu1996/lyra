...
// calls it, and marshals the result back. `sv_name` names the subroutine that
// entry point calls; `foreign_name` is the C linkage name (LRM 35.5.3). The ABI
// projection of the signature is resolved once here, where slang types are
// available.
